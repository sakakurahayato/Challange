  ...
  <div class="body-wrap">
    ...
    <form action="/check" method="POST">
      ...
      <div class="flex">
        ...
        <input type="text" class="family-name" name="fullname[]" value="">
      ...
      <div class="flex">
        ...
        <!-- 半角変換 ハイフンなしエラー出てない-->
        <input type="text" name="postcode" class="postcode" id="postcode" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');">
      </div>
      ...
      <div class="flex">
        ...
        <input type="text" class="input" name="building_name">
      </div>
      ...
      <div class="flex">
        ...
        <textarea class="textarea" rows="4" cols="30" name="opinion"></textarea>
      </div>
